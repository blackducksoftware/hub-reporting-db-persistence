...
then
	time -p  psql -f /opt/blackduck/hub/auditor/query/refresh_mat_views_concurrently.psql bds_hub
	time -p  psql -f /opt/blackduck/hub/auditor/query/refresh_mat_views_aux_concurrently.psql bds_hub
else
